...
```{python}
#| eval: FALSE
python -m pip install pandas altair plotly.express
```
...
```
![](AltairCharts/chart1.png){width="400"}
...
```
![](PlotlyCharts/chart1.png){width="600"}
:::
::::

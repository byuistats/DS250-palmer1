...
_Each of the 7 projects is worth 5 points. There is a draft submission due Wednesday (W) of the 2nd week of the project and the final draft due the following Saturday (S). This gives you 2 attempts to get full points on the project. There are 6 two-week projects (P0-P5) and 1 one-week project (P6). Typically no resubmissions are allowed once the project closes in Canvas. Make the changes and take advantage of the resubmit within this window._

_Projects 1-5 will have stretch questions. You must complete all the core qeustions first before attempting the stretch questions. You must complete all the stretch questions accurately for the project to count toward the competencies. The number in the competencies relating to Project Stretches is the number of projects with all the stretch questions completed._
